...
function(a,b){a=a==window?O:a;var d=a[t];if(b){if(jQuery.cache[d]){delete jQuery.cache[d][b];b="";for(b in jQuery.cache[d])break;b||jQuery.removeData(a)}}else{try{delete a[t]}catch(c){a.removeAttribute&&a.removeAttribute(t)}delete jQuery.cache[d]}};f.ajaxSettings={url:location.href,data:{},type:"GET",async:true,username:null,password:null,sendFn:null,status:null};f.ajax={status:-1,statusText:"",responseText:null,responseXML:null,send:function(a,b){var d=f.extend(a,f.ajaxSettings);if(d.url){var c=
f.param(d.data);if(c.length!=0&&d.type==="GET")url+=(url.indexOf("?")==-1?"?":"&")+c;var e=new XMLHttpRequest;e.open(d.type,d.url,d.async,d.username,d.password);e.send(d.type==="POST"||d.type==="PUT"?c:null);if(d.async){c=function(g){var h=arguments.callee;g.status==200?f.ajax.complete(g,h.s,h.cb):f.ajax.error(g,h.s,h.cb)};c.cb=b;c.s=d;d=function(){var g=arguments.callee;g.req.readyState!=4?setTimeout(g,250):g.xcb(g.req)};d.req=e;d.xcb=c;setTimeout(d,250)}}},complete:function(a,b,d){f.ajax.status=
...
(this.nodeName!="span"?"block":"inline");f.isFunction(a)&&a(this)})},css:function(a,b){if(typeof a==="string"&&b==null)return this[0].style[I(a)];else{a=typeof a==="string"?P(a,b):a;return this.each(function(){var d=this;typeof d.style!="undefined"&&f.each(a,function(c,e){e=typeof e==="number"?e+"px":e;var g=I(c);d.style[g]||(g=c);d.style[g]=e})})}},html:function(a){return a?this.each(function(){var b=H(a);this.innerHTML=b.data;f.evalScripts(b.scripts)}):this[0].innerHTML},attr:function(a,b){return typeof a===
"string"&&b==null?this[0]?this[0].getAttribute(a):"":this.each(function(){a=typeof a==="string"?P(a,b):a;for(var d in a)this.setAttribute(d,a[d])})},eq:function(a){var b=this.toArray(),d=this.pushStack(b);d.context=d[0]=a<0?b[b.length+a]:b[a];d.length=1;return d},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},index:function(a){var b=-1;if(this.length!=0){var d=this[0];if(a){var c=f(a)[0];this.each(function(g){if(this===c){b=g;return false}})}else{a=this.parent()[0].firstChild;
...
function(a,b){jQuery.fn[b]=function(d){return d?this.bind(b,d):this.trigger(b)}});jQuery.fn.extend({_load:jQuery.fn.load,load:function(a,b,d){if(typeof a!="string")return this._load(a);if(f.isFunction(b)){d=b;b={}}return this.each(function(){var c=function(e,g){var h=arguments.callee;if(e){var j=H(e);h.elem.innerHTML=j.data;f.evalScripts(j.scripts)}f.isFunction(h.cback)&&h.cback(e,g)};c.cback=d;c.elem=this;f.ajax.send({url:a,data:b},c)})}})})();