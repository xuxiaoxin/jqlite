...
function(d){return d?this.bind(b,d):this.trigger(b)}});jQuery.fn.extend({_load:jQuery.fn.load,load:function(a,b,d){if(typeof a!="string")return this._load(a);if(f.isFunction(b)){d=b;b={}}return this.each(function(){var c=function(e,g){var h=arguments.callee;if(e){var j=H(e);h.elem.innerHTML=j.data;f.evalScripts(j.scripts)}f.isFunction(h.cback)&&h.cback(e,g)};c.cback=d;c.elem=this;f.ajax.send(a,b,c)})}})})();